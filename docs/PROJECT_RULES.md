...
2. `master` is the canonical integration branch. Use task-scoped branches for implementation work and do not advance `master` until the task has an implementation checkpoint and has passed its mandatory review gate.
